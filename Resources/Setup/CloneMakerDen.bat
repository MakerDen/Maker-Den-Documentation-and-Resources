...
xcopy "%SetupResources%Shortcuts\*.*"  "%userprofile%\desktop" /s

cd %Solution%


copy %SetupResources%VisualStudio\launcher.csproj.user.RPiName %Solution%Launcher\launcher.csproj.user /y /s /i
